...
--turns customer data types into instance data
--unstable vs. stable verison - stable version implicitly specifies constructor 
--on a per instance base - use stable version in production code
PlutusTx.unstableMakeIsData ''MyRedeemer

{-# INLINABLE mkValidator #-}
-- This should validate if and only if the two Booleans in the redeemer are equal!
mkValidator :: () -> MyRedeemer -> ScriptContext -> Bool
mkValidator _  (MyRedeemer a b)  _ = traceIfFalse "wrong redemeer" (a == b)
