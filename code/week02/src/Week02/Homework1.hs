...
-- The validator takes a Tuple of Bools
mkValidator :: () -> (Bool, Bool) -> ScriptContext -> Bool
--the traceIfFalse funtion is handy for logging and returning Bool
mkValidator _ r _ = traceIfFalse "wrong redemeer" (fst r == snd r)

-- specifying the types of the redeemer and datum - boilerplate stuff 
-- customize based upon types
...
grab bs = do
    logInfo @String $ "grab has been called"
